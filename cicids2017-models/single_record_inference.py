...
# Prerequisite: run cicids2017-modelv3.py first to produce:
#   - preprocessor_cic_ids_2018.pkl
#   - svd_cic_ids_2018.pkl
#   - cicids2017-models/fhe_model_2_estimators_4_depth_svd_100_components/
...
def load_and_preprocess():
    ...
    (produced by cicids2017-modelv3.py).
    """
...
def predict_single_record_with_comparison(estimators, depth, records=1000, n_components_svd=100):
    ...
    model_dir = f"./cicids2017-models/fhe_model_{estimators}_estimators_{depth}_depth_svd_{n_components_svd}_components/"
