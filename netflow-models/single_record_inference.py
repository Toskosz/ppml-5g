...
# Prerequisite: run netflow-models/model.py first to produce:
#   - preprocessor_cicunsw.pkl
#   - svd_cicunsw.pkl
#   - netflow-models/fhe_model_<n>_estimators_<d>_depth_svd_100_components/
...
def load_and_preprocess():
    ...
    (produced by netflow-models/model.py).
    """
...
def predict_single_record_with_comparison(estimators, depth, records=1000, n_components_svd=100):
    ...
    model_dir = f"./netflow-models/fhe_model_{estimators}_estimators_{depth}_depth_svd_{n_components_svd}_components/"
    ...
    try:
        ...
        print("Please run netflow-models/model.py first to generate the FHE assets.")
        return
